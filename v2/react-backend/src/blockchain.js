...
const MATTERCLOUD_API_KEY = process.env.MATTERCLOUD_API_KEY
...
class BlockchainServer {
  constructor (options = {}) {
    ...
    this.axios = axios.create({
      ...
      headers: { 'Accept-Encoding': 'gzip', 'api_key': MATTERCLOUD_API_KEY } // Run and BitIndex use this
    })
    this.bsvNetwork = options.network === 'main' ? 'mainnet' : 'testnet'
