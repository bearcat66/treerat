...
export default class Coingeek extends React.Component {
  constructor(props) {
    super(props)
    ...
    return (
      <div className="jumbotron jumbotron-transparent-25">
        <div className="container-fluid text-center">
          <img width='400' height='200' src="https://www.blocksocial.com/wp-content/uploads/2019/12/coingeekconference.jpg"/>
          <ul/>
          <h3 style={{color: '#1a6bbe',  fontFamily: 'arial', fontWeight: '600'}}>Browse London</h3>
          <hr/>
          {this.renderMap()}
...
async function loadPlaces() {
  return fetch('/api/locations/coingeek').then(res=>res.json()).then(l => {
    return l
  })
}
